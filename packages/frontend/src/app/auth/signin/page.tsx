...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Use the actual API endpoint instead of simulation
  ...
  return (
    <div className="max-w-md w-full p-8 bg-white rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex justify-between">
            ...
            <Link href="/auth/reset-password" className="text-sm text-blue-800 hover:underline">
              Forgot password?
            </Link>
          </div>
          <input
      ...
      <p className="mt-8 text-center text-sm text-gray-600">
        ...
        <Link href="/auth/signup" className="font-medium text-blue-800 hover:text-blue-700">
          Sign up
        </Link>
      </p>
    </div>
