  ...
  return (
    <div className="max-w-md w-full p-8 bg-white rounded-lg shadow-md">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-2">Join us to start managing your projects effectively</p>
      </div>
      ...
      <p className="mt-8 text-center text-sm text-gray-600">
        ...
        <Link href="/auth/signin" className="font-medium text-blue-800 hover:text-blue-700">
          Sign in
        </Link>
      </p>
    </div>
